...
void *mlx_new_window(mlx_ptr_t *mlx_ptr,int pos_win_x, int pos_win_y, int size_x, int size_y, char *title)
{
  ...
  NSRect windowRect = NSMakeRect(pos_win_x, pos_win_y, size_x, size_y);
